...
class punto_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "configuracion_USRP", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("configuracion_USRP")
        ...
        self.settings = Qt.QSettings("GNU Radio", "punto_2")
        ...
        self._GTX_range = Range(0, 1, 100e-6, 1, 200)
...
def main(top_block_cls=punto_2, options=None):
